...
if [ "$1" = "$FDEVICE" -o "$FOX_BUILD_DEVICE" = "$FDEVICE" ]; then
    ...
    export FOX_USE_SPECIFIC_MAGISK_ZIP="/home/hyper/ahmed/fox_11/device/realme/RMX1851/Magisk-v25.1.zip"
...
# --- upload --- #
zipfile=$(find /home/hyper/ahmed/fox_11/out/target/product/RMX1851/ -iname OrangeFox-*.zip -printf "%f\n")
scp /home/hyper/ahmed/fox_11/out/target/product/RMX1851/$zipfile hyper@hyper.remainsilent.net:/var/www/html/builds/roms/RMX1851
